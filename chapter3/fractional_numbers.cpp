...
int main(){
    ...
    _______________________________________________ My own practice _______________________________________________________
    ...
    */
    ...
    //Infinity
    double infinty{num10/num11};

    cout<<  infinty << endl;

    //Nan
    double nan_var{num11/num12};

    cout<< nan_var << endl;

    // Precisions
    cout << setprecision(10);
    double num1 {1.26126622e-11};
    ...
    _____________________________ Practice from lesson
